...
@Component({
  selector: 'app-ameaca',
  templateUrl: './ameaca.component.html',
  styleUrls: ['./ameaca.component.css']
})
export class AmeacaComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/ameaca', dados).subscribe(response => {
