...
@Component({
  selector: 'app-ofensas-raciais',
  templateUrl: './ofensas-raciais.component.html',
  styleUrls: ['./ofensas-raciais.component.css']
})
export class OfensasRaciaisComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/ofensas-raciais', dados).subscribe(response => {
