...
@Component({
  selector: 'app-roubo',
  templateUrl: './roubo.component.html',
  styleUrls: ['./roubo.component.css']
})
export class RouboComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/roubo', dados).subscribe(response => {
