...
@Component({
  selector: 'app-pertubacao',
  templateUrl: './pertubacao.component.html',
  styleUrls: ['./pertubacao.component.css']
})
export class PertubacaoComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/pertubacao', dados).subscribe(response => {
