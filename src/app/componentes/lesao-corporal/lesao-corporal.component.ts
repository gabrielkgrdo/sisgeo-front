...
@Component({
  selector: 'app-lesao-corporal',
  templateUrl: './lesao-corporal.component.html',
  styleUrls: ['./lesao-corporal.component.css']
})
export class LesaoCorporalComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/lesao-corporal', dados).subscribe(response => {
