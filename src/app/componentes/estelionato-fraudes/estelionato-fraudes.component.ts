...
@Component({
  selector: 'app-estelionato-fraudes',
  templateUrl: './estelionato-fraudes.component.html',
  styleUrls: ['./estelionato-fraudes.component.css']
})
export class EstelionatoFraudesComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/estelionato', dados).subscribe(response => {
