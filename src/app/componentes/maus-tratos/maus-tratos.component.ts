...
@Component({
  selector: 'app-maus-tratos',
  templateUrl: './maus-tratos.component.html',
  styleUrls: ['./maus-tratos.component.css']
})
export class MausTratosComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/maus-tratos', dados).subscribe(response => {
