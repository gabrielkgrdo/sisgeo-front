...
@Component({
  selector: 'app-desaparecimento-pessoa',
  templateUrl: './desaparecimento-pessoa.component.html',
  styleUrls: ['./desaparecimento-pessoa.component.css']
})
export class DesaparecimentoPessoaComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/desaparecimento-de-pessoa', dados).subscribe(response => {
