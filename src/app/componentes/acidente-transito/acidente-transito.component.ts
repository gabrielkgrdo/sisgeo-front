...
@Component({
  selector: 'app-acidente-transito',
  templateUrl: './acidente-transito.component.html',
  styleUrls: ['./acidente-transito.component.css']
})
export class AcidenteTransitoComponent implements OnInit {
  ...
  enviarDadosParaEndpoint() {
    ...
    this.http.post('http://localhost:8080/acidente-transito', dados).subscribe(response => {
